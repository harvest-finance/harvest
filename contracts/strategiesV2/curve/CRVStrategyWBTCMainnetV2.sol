...
contract CRVStrategyWBTCMainnetV2 is CRVStrategyWRenBTCV2 {
  ...
  address constant public __hbtcMix = address(0xb19059ebb43466C323583928285a49f558E572Fd);
  ...
  // address constant public __gauge = address(0xB1F2cdeC61db658F091671F5f199635aEF202CAC); // ren gauge
  address constant public __gauge = address(0x4c18E409Dc8619bFb6a1cB56D114C3f592E0aE79); //hbtc gauge
  address constant public __mintr = address(0xd061D61a4d941c39E5453435B6345Dc261C2fcE0); // _mintr

  // protocols
  address constant public __hbtcPool = address(0x4CA9b3063Ec5866A4B82E437059D2C43d1be596F);
  //address constant public __renPool = address(0x93054188d876f558f4a66B2EF1d97d16eDf0895B); // ren pool
  ...
  CRVStrategyWRenBTCV2(
    ...
    __hbtcMix,
    __hbtcPool, // curve protocol's pool for WBTC
