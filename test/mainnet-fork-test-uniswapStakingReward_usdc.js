  ...
  contract("Mainnet Uniswap Staking Reward", function(accounts){
    describe("Uniswap Staking Reward earnings", function (){
      ...
      async function setupExternalContracts() {
        ...
        cropPool = await SNXRewardInterface.at(MFC.UNISWAP_ETH_USDC_STAKING_POOL_ADDRESS);
        ...
        token1Path = [MFC.UNI_ADDRESS, MFC.WETH_ADDRESS, MFC.USDC_ADDRESS];
        token0 = await IERC20.at(MFC.WETH_ADDRESS);
        token1 = await IERC20.at(MFC.USDC_ADDRESS);
      }
