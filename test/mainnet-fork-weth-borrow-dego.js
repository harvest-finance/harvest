...
if ( process.env.MAINNET_FORK ) {
  ...
  contract("DEGO WETH Borrow", function(accounts){
    describe("WETH Borrow Strategy", function (){
      ...
      it("A farmer investing weth and liquidity is borrowed", async function () {
        ...
        console.log("Strategy Weth after:", (strategyWethBalanceAfter).toString());
        console.log("Recipient Weth after:", (recipientWethBalanceAfter).toString());
        console.log("Recipient Farm after:", (recipientFarmBalanceAfter).toString());
