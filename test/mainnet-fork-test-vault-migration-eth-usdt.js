  ...
  contract.only("Mainnet Vault Migration", function(accounts){
    describe("ETH-USDT Vault", function (){
      ...
      async function setupExternalContracts() {
        oldVault = await Vault.at(MFC.VaultUNI_LP_WETH_USDT);
        newVault = await Vault.at(MFC.ProxiedVault_UNI_LP_WETH_USDT);
        migrator = await RewardPool.at(MFC.Proxied_UNI_LP_WETH_USDTPool);
        vaultMigrationStrategy = await VaultMigratorStrategy.at(MFC.MigrationStrategy_UNI_LP_WETH_USDT);
      }
